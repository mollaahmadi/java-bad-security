...
; $Id: tomcat.nsi 304725 2005-09-23 13:40:26Z yoavs $
...
Section "Native" SecTomcatNative
  ...
  NSISdl::download /TIMEOUT=30000 http://tomcat.heanet.ie/native/1.1.0/binaries/win32/tcnative-1.dll $INSTDIR\bin\tcnative-1.dll
  Pop $0
  StrCmp $0 success success
    SetDetailsView show
    DetailPrint "download failed from http://tomcat.heanet.ie/native/1.1.0/binaries/win32/tcnative-1.dll: $0"
  success:
